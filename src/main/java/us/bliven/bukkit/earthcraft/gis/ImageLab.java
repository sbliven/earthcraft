...
public class ImageLab {
	...
	private void getLayersAndDisplay() throws Exception {
		File shapeFile = new File(ClassLoader.getSystemResource("countries.shp").toURI());
		//File imageFile = new File(ClassLoader.getSystemResource("bluemarble.tif").toURI());
		URL url = ClassLoader.getSystemResource("w140n40.Bathymetry.srtm.dem");
		File file = new File(url.getFile());
		displayLayers(file, shapeFile);
	}
	/**
	...
	private void displayLayers(File rasterFile, File shpFile) throws Exception {
		...
		menu.add( new SafeAction("Grayscale display") {
			private static final long serialVersionUID = -7148364177846847116L;
		...
		menu.add( new SafeAction("RGB display") {
			private static final long serialVersionUID = -2155761915830989230L;
			@Override
			public void action(ActionEvent e) throws Throwable {
