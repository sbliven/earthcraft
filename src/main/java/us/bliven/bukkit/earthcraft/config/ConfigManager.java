...
//		ConfigurationSection params = get(joinCategories("worlds",worldname));
//		if( params == null ) {
...
//	}
//
//	public static String joinCategories(String... categories) {
//		return String.join(Configuration.CATEGORY_SPLITTER, categories);
//	}
//	/*
